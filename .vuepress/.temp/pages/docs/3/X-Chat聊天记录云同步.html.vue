<template><div><h2 id="x-chat-v2-聊天记录云同步" tabindex="-1"><a class="header-anchor" href="#x-chat-v2-聊天记录云同步"><span>X-Chat V2 聊天记录云同步</span></a></h2>
...
<li>
<p>实时、无感知同步数据，多台设备的数据实时在话题记录中显示，无需刷新页面，保证用户使用体验；</p>
</li>
<li>
<p>同步后，在原有记录基础上进行合并，不会覆盖原有记录；</p>
</li>
</ol>
<h3 id="注意事项" tabindex="-1"><a class="header-anchor" href="#注意事项"><span>注意事项：</span></a></h3>
<ol>
<li>
<p>用户需要在 <code v-pre>X-Chat V2</code> 版本使用；</p>
</li>
<li>
...
<p>你可以理解为只可以在线点对点传输数据，这种方法保证了用户隐私数据在同步过程中只会经过用户这几台设备。</p>
</div>
...
<ol start="4">
<li>成功登录后，你可以在聊天页面左上角中看到当前设备在线列表及同步状态。</li>
</ol>
</div></template>
