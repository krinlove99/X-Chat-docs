...
:::tip 更新时间
2024年6月1日20:42:43 模型倍率尚未更新，当前倍率不代表实际倍率
:::

API开放平台采用token数量制，即用户预先购买一定数量的token额度，每次对话将消耗账户中的token额度。
...
| VIP | 1 | 指通过实际充值获得额度的用户等级。该等级可以使用所有API调用服务及支持的大模型 |
| VIP+ | 1 | 在Arcnix各种官方庆祝活动/服务内测/社区卓越贡献获得的资格，可永久免费使用API调用服务及支持的大模型 |
